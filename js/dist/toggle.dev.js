...
var toggleInfo = function toggleInfo(el) {
  if (!toggle) {
    toggle = true;
    ...
    try {
      for (var _iterator3 = descriptions[Symbol.iterator](), _step3; !(_iteratorNormalCompletion3 = (_step3 = _iterator3.next()).done); _iteratorNormalCompletion3 = true) {
        var _d = _step3.value;
        _d.style.zIndex = "0";

        var _ps = _d.getElementsByTagName("p");
        ...
        try {
          for (var _iterator4 = _ps[Symbol.iterator](), _step4; !(_iteratorNormalCompletion4 = (_step4 = _iterator4.next()).done); _iteratorNormalCompletion4 = true) {
            var _p = _step4.value;
